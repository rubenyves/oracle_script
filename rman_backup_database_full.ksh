...
#
# NOM
#   rman_backup_database_full.ksh
#
# DESCRIPTION
#   Sauvegarde RMAN full d'une base de donnees
#
# REMARQUES
#
...
#
#    En sortie : 
#            Fichier journal /oradata/<SID>/s01/<SID>_rman_backup_database_full_jjmmyyyy_hhHmm.log
#
# MODIFICATIONS
...
#    Adrian Benga     (FT/OLNC/IBNF/ITE/ECV) - 24/01/2012 - Evolution 1.2.0
...
#----------------------------------------------------------------------------------------------------
# Test de la presence de la base de donnees
#----------------------------------------------------------------------------------------------------
...
#----------------------------------------------------------------------------------------------------
# Determination du role courant de la base de donnees : PRIMARY ou PHYSICAL STANDBY
#----------------------------------------------------------------------------------------------------
database_role()
{
database_test
...
#----------------------------------------------------------------------------------------------------
# Renvoi la valeur de l'execution d'une requete SELECT
#     $1 : requete SQL sans mot select
#----------------------------------------------------------------------------------------------------
oracle_var()
{
...
run {
backup full database format='${repsvg}/%d_RMAN_DATABASE_FULL_%D%M%Y_BS%s_BP%p_%t' TAG='$ORACLE_SID FULL $time';
...
log=/oradata/${ORACLE_SID}/s01/${ORACLE_SID}_rman_backup_database_full_$time.log
history=/oradata/${ORACLE_SID}/adm/dbalog/${ORACLE_SID}_history.log
text="Rman Backup Database Full          "
