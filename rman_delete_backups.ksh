...
#
# NOM
#   rman_delete_backups.ksh
#
# DESCRIPTION
#   Suppression des sauvegardes rman (en fonction du parametre retention policy)
#   dans le fichier de controle
#
# REMARQUES
#
...
#
#    En sortie : 
#            Fichier journal /oradata/<SID>/adm/dbalog/rman_delete_backups_jjmmyyyy_hhHmm.log
#
# MODIFICATIONS
...
#----------------------------------------------------------------------------------------------------
# Removing RMAN backups from repository (control file)
#----------------------------------------------------------------------------------------------------
rman_delete_backups()
{
target=/
...
log=/oradata/${ORACLE_SID}/adm/dbalog/rman_delete_backups_$time.log
history=/oradata/${ORACLE_SID}/adm/dbalog/${ORACLE_SID}_history.log
text="Rman Delete Backups                 "
