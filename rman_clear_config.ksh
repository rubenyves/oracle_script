...
#
# NOM
#   rman_clear_config.ksh
#
# DESCRIPTION
#   Reinitialisation aux valeurs par defaut de la configuration RMAN dans le fichier controle   
#
# REMARQUES
#
...
#
#    En sortie : 
#          Fichier journal /oradata/SID/adm/dbalog/rman_clear_config_jjmmyyyy_hhHmm.log
#
# MODIFICATIONS
#    Fabrice CHAILLOU (FT/DROSI/DPS/ISS) - 19/08/2005 - 1.0.0 - Creation
#    Fabrice CHAILLOU (FT/ROSI/DPS/ITE)  - 11/09/2006 - 1.1.0 - Modification fonction database role
#    Fabrice CHAILLOU (FT/ROSI/DPS/ITE)  - 08/01/2007 - 1.2.0 - Desactivation Block Change Tracking
...
log=/oradata/${ORACLE_SID}/adm/dbalog/rman_clear_config_$time.log
history=/oradata/${ORACLE_SID}/adm/dbalog/${ORACLE_SID}_history.log
text="Rman Clear Config                   "
