...
#
# NOM
#   rman_crosscheck_archivelogs.ksh
#
# DESCRIPTION
#   Si au moins un fichier Archive Log a ete supprime par une commande OS sans etre sauvegarde
#   par RMAN, alors un controle de validite doit etre necessaire dans le repository RMAN 
#
# REMARQUES
#
...
#
#    En sortie : 
#            Fichier journal /oradata/<SID>/adm/dbalog/rman_crosscheck_archivelogs_jjmmyyyy_hhHmm.log
#
# MODIFICATIONS
...
#----------------------------------------------------------------------------------------------------
# Removing archive log files backed up since n days 
#----------------------------------------------------------------------------------------------------
rman_crosscheck_archivelogs()
{
target=/
...
log=/oradata/${ORACLE_SID}/adm/dbalog/rman_crosscheck_archivelogs_$time.log
history=/oradata/${ORACLE_SID}/adm/dbalog/${ORACLE_SID}_history.log
text="Rman Crosscheck Archives Logs       "
